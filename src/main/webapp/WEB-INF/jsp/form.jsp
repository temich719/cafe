...
<html>
    ...
    <body>
        ...
        <div id="mainDivForm">
            <h1 style="margin-left: 31.5%;margin-top: 3%;font-family:Denistina;font-size: 50px;">Оформление заказа</h1>

            <div style="margin-left: 15%;">
                <form action="" method="post">
                    <input type="hidden" name="command" value="CREATE_ORDER">
                    <input type="text" name="name" placeholder="Имя" style="width: 300px;height: 20px;">
                    <br><br><br>
                    <input type="text" name="surname" placeholder="Фамилия" style="width: 300px;height: 20px;">
                    <br><br><br>
                    <button type="submit" class="choice" style="width: 307px;height: 50px;">
                        Заказать
                    </button>
                </form>
            </div>
