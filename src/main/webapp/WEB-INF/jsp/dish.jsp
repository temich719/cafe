...
<html>
    ...
    <body style="background-image: url('../img/bu2.jpg');">
        ...
        <div>
            <nav>
                 <ul class="menu" style="margin-left: 28.2%;">
        ...
        <div id="mainDivDish">
            <h1 style="margin-left: 40%;margin-top: 3%;font-family:Denistina;font-size: 50px;">Название</h1>


            <div>
                <img src="img/bread2-removebg-preview.png" alt="dish" width="437.25px" height="321px" style="margin-left:5%;margin-top: -3%;">
                <span>
                    <h1 style="margin-left: 62%;margin-top: -32%;font-family:Denistina;font-size: 64px;">
                        Цена:
                    </h1>
                </span>
                <span>
                    <h1 style="margin-left: 62%;margin-top: -2%;font-family:Denistina;font-size: 64px;">
                        25 руб.
                    </h1>
                </span>
                <br><br><br>
                <span style="margin-left: 37%;margin-top: 20%;font-family:Denistina;font-size: 64px;">
                    Описание:
                </span>
                <br><br>
                <span style="margin-left: 5%;margin-top: 27%;">
                ...
                <div>
                    <form action="" method="post">
                        <input type="hidden" name="command" value="ADD_TO_BASKET_COMMAND">
                        <input type="hidden" name="id">
                        <button id="but" type="submit" style="width: 30%;height: 60px;color: white;background-color: orange;border: none;margin-left: 33%;margin-top: 5%;">
                            Добавить в корзину
                        </button>
                    </form>
                </div>
