...
<html>
    ...
    <body style="background-image: url('../img/bu2.jpg');">
        ...
        <div id="mainDivThanks">
            <h1 style="margin-left: 32.5%;margin-top: 3%;font-family:Denistina;font-size: 50px;">Спасибо за заказ!</h1>


            <span style="margin-left: 35%;margin-top: -5%;font-size: 40px;">
                Наш повар уже
            </span>

            <img src="img/cook.png" alt="cooker" width="250px" height="250px" style="position: absolute;margin-top: 5%;margin-left: -29%;">

            <br><br><br><br><br><br><br><br><br><br><br><br><br><br>
            <span style="margin-left: 24%;margin-top: 25%;font-size: 40px;">
            ...
            <div style="margin-top: 8%;margin-left: 20%;">
                <form action="" method="get">
                    <input type="hidden" name="command" value="GO_TO_PAGE_COMMAND">
                ...
                <form action="" method="get">
                    <input type="hidden" name="command" value="GO_TO_PAGE_COMMAND">
                    <button type="submit" class="choice" style="background-color: rgb(168, 167, 167);">
                        К моим заказам
                    </button>
                </form>
            </div>
